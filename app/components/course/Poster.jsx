...
var data = {
	  ...
	  eduinfo: {
		...
		chart: {
			...
			desc: [
				...
				{
					title: "창의적 사고",
					content: "자신의 생각과 디자인을 직접 HTML, CSS로 표현하면서 창의력을 기를 수 있습니다."
				},
			]
		}
	},
	  ...
	  eduinfo: {
		...
		chart: {
			...
			desc: [
				...
				{
					title: "개발 응용 능력",
					content: "파이썬은 C나 Java보다 쉽지만 C, Java에서 사용하는 개념과 기능들을 전부, 혹은 더 많이 갖추고 있습니다. 또한 서버부터 앱까지 다양한 개발에 사용됩니다."
				}
			]
		}
	},
	  ...
	  eduinfo: {
		...
		chart: {
			...
			desc: [
				{
					title: "개발 응용 능력",
					content: "HTML, CSS 뿐만 아니라 Javascript 까지 학습하며 프로그래밍 전반에 대한 지식을 배울 뿐 아니라 이를 통해 눈에 보이는 결과물(웹사이트)을 만들어낼 수 있습니다."
				},
				{
					title: "창의적 사고",
					content: "자신의 생각과 디자인을 직접 HTML, CSS로 표현하면서 창의력을 기를 수 있습니다."
	  ...
	  eduinfo: {
		...
		chart: {
			...
			desc: [
				{
					title: "개발 응용 능력",
					content: "전 세계에서 가장 많이 쓰이는 안드로이드 플랫폼에서 구동되는 앱을 만듭니다. 또한 Java 언어를 배우며 더 나아간 프로그래밍 능력을 개발할 수 있습니다."
				},
				{
					title: "문제해결 능력",
					content: "프로그래밍을 통해 여러 문제들을 해결하며 문제해결 능력을 기를 수 있습니다."
				},
				{
					title: "논리적 사고",
					content: "문제 해결을 위해 프로그래밍을 하며 컴퓨터적 사고를 하는 과정에서 논리적 사고 능력을 기를 수 있습니다."
	...
	ap: {
	    ...
	    title: "Ap",
	    subtitle: "Ap",
	    desc: "AP(Advanced Placement)는 미국 고등학교에서 수강하는 대학교 수준의 교과과정을 의미합니다. 즉, 우수한 학생들이 대학입시 전에 대학 학점을 얻을 수 있도록 하는 제도로써 College Board에서 주관합니다. 매년 백만 명 이상의 학생들이 응시하는 전 세계적인 시험으로 한국에서도 많은 학생들이 응시합니다.",
			target: "중학교 1학년 이상 친구들",
	    needed: "노트북",
			term: "12주",
			time: "매주 180분"
	  ...
	  eduinfo: {
	    desc: "Java 프로그래밍 언어를 기본으로 사용합니다. Foundations of Computer Science, Data Structure, Algorithm 등 대학교 수준의 Computer Science를 배웁니다.",
	    image: "img/ap.jpg",
			imageBorder: true,
	    youtube: "",
	    vimeo: ""
		...
		chart: {
			...
			desc: [
				{
					title: "논리적 사고",
					content: "Computer Science 전반에 대한 지식과 함께 자료구조, 알고리즘을 배우며 논리적 사고 능력을 키울 수 있습니다."
				},
				{
					title: "문제해결 능력",
					content: "주어진 문제를 Computer Science 측면에서 접근하여 해결합니다. 이 과정에서 문제해결 능력을 키울 수 있습니다."
				},
				{
					title: "개발 응용 능력",
					content: "특정한 플랫폼 언어를 학습하지는 않지만, 일반적인 컴퓨터 과학을 학습하여 어떤 프로그래밍 언어를 접하더라도 금방 익숙해질 수 있습니다."
				},
			]
		}
	}
